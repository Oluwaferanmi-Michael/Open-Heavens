            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              title:  Column(
                ...
                children: [
                  Text(
                    '4th January',
                    style: bodyText1(context, color: black),
                  ),
                  Text(
                    'TODAY\'S READ',
                    style: subtitle2(context, color: black),
                  ),
                  Text(
                    'THE BEGINNING OF MONTHS',
                    style: bodyText1(context, fontWeight: FontWeight.bold, color: black),
                  ),
                  // const SizedBox(
                  //   height: 12,
                  // ),
...
Widget devotional(BuildContext context) => SliverToBoxAdapter(
  child: Padding(
    ...
    child: SizedBox(
      ...
      child: Column(
              ...
              children: [
                Text(
                'Memory Verse',
                style: subtitle1(context, fontWeight: FontWeight.bold),
          ),
          const SizedBox(
                height: 12,
          ),
